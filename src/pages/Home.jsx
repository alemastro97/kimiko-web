...
import {
  Sparkles, Heart, Shirt, Zap, Star, Wand2, Flame, PawPrint,
  Backpack, Users, Image, ArrowRight, Check
} from 'lucide-react'

const pricing = [
  {
    title: 'Full Body', price: '$30', Icon: Sparkles,
      ...
      <section className="snap-start min-h-screen flex flex-col justify-center py-16 px-6 bg-gradient-to-b from-white to-sakura-100">
        <div className="max-w-5xl mx-auto w-full">
          ...
          <div className="flex justify-center">
            {pricing.map((p) => (
              <div key={p.title} className={`card-glow relative bg-gradient-to-b ${p.gradient} rounded-3xl p-8 text-center border w-full max-w-sm ${p.featured ? 'border-gold-400 shadow-xl' : 'border-sakura-200 shadow-md'}`}>
                {p.featured && (
