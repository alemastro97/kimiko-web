    ...
    <Router>
      <div className="min-h-screen bg-sakura-50 font-sans flex flex-col">
        ...
        <footer className="fixed bottom-0 left-0 right-0 z-50">
          ...
          {/* colored band with grid */}
          <div className="bg-sakura-500 relative overflow-hidden">
            {/* grid overlay */}
            <div
              className="absolute inset-0 opacity-20"
              style={{
                backgroundImage: 'linear-gradient(#a82e58 1px, transparent 1px), linear-gradient(90deg, #a82e58 1px, transparent 1px)',
            ...
            <div className="relative flex items-center justify-between px-8 py-4 max-w-5xl mx-auto">
              {/* left badge */}
              <div className="bg-gold-400 text-sakura-700 text-xs font-extrabold px-4 py-2 rounded-xl border-2 border-sakura-600 shadow rotate-[-3deg] hidden md:block">
                Commissions<br />OPEN ✦
              </div>
              ...
              <Link
                to="/commission"
                className="bg-white text-sakura-500 font-extrabold text-base px-10 py-3 rounded-full border-4 border-sakura-700 shadow-lg hover:scale-105 transition-transform font-kawaii tracking-wide"
              >
                Order your Chibi!
              </Link>

              {/* right badge */}
              <div className="bg-sakura-100 text-sakura-600 text-xs font-extrabold px-4 py-2 rounded-xl border-2 border-sakura-600 shadow rotate-[3deg] hidden md:block">
                Starting<br />at $15 ✦
              </div>
            </div>
          </div>
          ...
          {/* bottom bar */}
          <div className="bg-sakura-50 border-t border-sakura-100 flex items-center justify-between px-8 py-2">
            <span className="text-xs text-sakura-400 font-kawaii">
              © {new Date().getFullYear()} Kimiko's Corner
            </span>
            <div className="flex items-center gap-4">
              <a href="https://www.instagram.com/kimiko_mg/" target="_blank" rel="noopener noreferrer"
                className="flex items-center gap-1 text-xs text-sakura-400 hover:text-sakura-600 transition font-semibold">
                <ExternalLink className="w-3.5 h-3.5" strokeWidth={2} /> Instagram
              </a>
              <a href="mailto:mg.kimikomg@gmail.com"
                className="flex items-center gap-1 text-xs text-sakura-400 hover:text-sakura-600 transition font-semibold">
